...
app.get('/bali',userLogged, function(req, res) {
  res.render('bali',{
    message: ' ',
    messageType: ' ',
  })
});
app.get('/cities',userLogged, function(req, res) {
  res.render('cities')
});
app.get('/hiking',userLogged, function(req, res) {
  res.render('hiking')
});
app.get('/home',userLogged, function(req, res) {
  res.render('home')

});
app.get('/inca',userLogged, function(req, res) {
  res.render('inca',{
    message: ' ',
    messageType: ' ',
  })
});
app.get('/islands',userLogged, function(req, res) {
  res.render('islands')
});
app.get('/paris',userLogged, function(req, res) {
  res.render('paris',{
    message: ' ',
    messageType: ' ',
  })
...
app.get('/rome',userLogged, function(req, res) {
  res.render('rome',{
    message: ' ',
    messageType: ' ',
  })
...
app.get('/santorini',userLogged, function(req, res) {
  res.render('santorini',{
    message: ' ',
    messageType: ' ',
  })
});
app.get('/annapurna',userLogged, function(req, res) {
...
app.get('/search',userLogged, function(req, res) {
  res.render('searchresults' ,{ destinations: [], message:' '});
});

app.post('/search',userLogged, async function (req, res) {
...
app.get('/wanttogo',userLogged, async function (req, res) {
  try {
    const db = client.db("myDB"); 
    const collection = db.collection("myCollection"); 
